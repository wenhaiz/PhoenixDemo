defmodule Hello.CatalogTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{description: nil, pirce: nil, title: nil, views: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      valid_attrs = %{description: "some description", pirce: "120.5", title: "some title", views: 42}

      assert {:ok, %Product{} = product} = Catalog.create_product(valid_attrs)
      assert product.description == "some description"
      assert product.pirce == Decimal.new("120.5")
    ...
    test "update_product/2 with valid data updates the product" do
      product = product_fixture()
      update_attrs = %{description: "some updated description", pirce: "456.7", title: "some updated title", views: 43}

      assert {:ok, %Product{} = product} = Catalog.update_product(product, update_attrs)
      assert product.description == "some updated description"
      assert product.pirce == Decimal.new("456.7")
